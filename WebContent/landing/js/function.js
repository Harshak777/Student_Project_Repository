...
newsletter.main = document.querySelector('.main-news');
newsletter.form = document.querySelector('.main-news > #singular-form');
newsletter.subs = document.querySelector('.main-news > #singular-form > button#subs');
newsletter.input = document.querySelector('.main-news>#singular-form>#email-input>input');
newsletter.submitButton = document.querySelector('.main-news > #singular-form > #email-input > button');
newsletter.successMessage = document.querySelector('.main-news > #singular-form > #success');
